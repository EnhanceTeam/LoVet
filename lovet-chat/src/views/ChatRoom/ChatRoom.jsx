...
const ChatRoom = () => {
  ...
  const handleRatingChipWebsiteFunctionalityClick = () =>
    setRatingChipWesbiteFunctionalityState(!ratingChipWebsiteFunctionalityState)
  const ratingChipWebsiteEaseOfUseValue = "Kemudahan Penggunaan Website"
  const [ratingChipWebsiteEaseOfUseState, setRatingChipWesbiteEaseOfUseState] =
    useState(false)
              ...
              <div>
                ...
                <div className="flex flex-row gap-x-2">
                  <Chip
                    ...
                    color={
                      ratingChipDoctorResponseState ? "primary" : "default"
                    }
                    variant={ratingChipDoctorResponseState ? "" : "outlined"}
                    onClick={handleRatingChipWebsiteDoctorResponseClick}
                  />
                  <Chip
                    label={ratingChipWebsiteFunctionalityValue}
                    color={
                      ratingChipWebsiteFunctionalityState
                        ? "primary"
                        : "default"
                    ...
                    variant={
                      ratingChipWebsiteFunctionalityState ? "" : "outlined"
                    }
                    onClick={handleRatingChipWebsiteFunctionalityClick}
                  />
                  <Chip
                    label={ratingChipWebsiteEaseOfUseValue}
                    color={
                      ratingChipWebsiteEaseOfUseState ? "primary" : "default"
                    }
                    variant={ratingChipWebsiteEaseOfUseState ? "" : "outlined"}
                    onClick={handleRatingChipWebsiteEaseOfUseClick}
                  />
                </div>
              </div>
              <div>
                <DialogContentText>
                  Apa yang bisa kami lakukan untuk meningkatkan layanan?
                </DialogContentText>
                <TextField
                  id="rating-feedback"
      ...
      <div className="flex flex-col h-screen">
        <div className="flex flex-row justify-center items-center gap-x-2 px-4 py-2 bg-primary-container drop-shadow">
          <div className="flex flex-auto flex-row justify-start items-center gap-x-4">
            ...
            <p className="font-bold">{username ? username : "Unknown"}</p>
          </div>
                ...
                {isValidUrl(message.text) ? (
                  ...
                  <div
                    ...
                    className={`rounded-2xl w-fit p-4 m-2 bg-surface-variant ${
                      message.uid === uid && "ml-auto bg-tertiary-container"
                    }`}
                  >
            ...
            <div className="flex flex-auto flex-row justify-center items-center gap-x-2">
              <form onSubmit={sendMessage} className="flex flex-auto">
                <TextField
                  ...
                  variant="outlined"
                  placeholder={
                    inputMessageDisabled ? "Waktu telah habis" : "Ketik pesan"
                  }
                  value={formValue}
